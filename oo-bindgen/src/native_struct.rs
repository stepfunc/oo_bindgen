...
impl StructElementType {
    pub fn to_type(&self) -> Type {
        match self {
            Self::Bool(_) => Type::Basic(BasicType::Bool),
            Self::Uint8(_) => Type::Basic(BasicType::Uint8),
            Self::Sint8(_) => Type::Basic(BasicType::Sint8),
            Self::Uint16(_) => Type::Basic(BasicType::Uint16),
            Self::Sint16(_) => Type::Basic(BasicType::Sint16),
            Self::Uint32(_) => Type::Basic(BasicType::Uint32),
            Self::Sint32(_) => Type::Basic(BasicType::Sint32),
            Self::Uint64(_) => Type::Basic(BasicType::Uint64),
            Self::Sint64(_) => Type::Basic(BasicType::Sint64),
            Self::Float(_) => Type::Basic(BasicType::Float),
            Self::Double(_) => Type::Basic(BasicType::Double),
