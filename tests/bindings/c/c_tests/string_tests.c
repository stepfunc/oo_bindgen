...
static void test_english_string()
{
    ...
    assert(strcmp(ENGLISH_STRING_1, foo_string_echo(string_class, ENGLISH_STRING_1)) == 0);
    ...
    assert(strcmp(ENGLISH_STRING_2, foo_string_echo(string_class, ENGLISH_STRING_2)) == 0);
...
static void test_french_string()
{
    ...
    assert(strcmp(FRENCH_STRING_1, foo_string_echo(string_class, FRENCH_STRING_1)) == 0);
    ...
    assert(strcmp(FRENCH_STRING_2, foo_string_echo(string_class, FRENCH_STRING_2)) == 0);
