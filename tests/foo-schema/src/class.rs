...
pub fn define(lib: &mut LibraryBuilder) -> Result<(), BindingError> {
    ...
    let get_value_cb = lib.define_one_time_callback("GetValueCallback")?
        .callback("on_value")?
            .param("value", Type::Uint32)?
            .arg("data")?
            .return_type(ReturnType::Void)?
    ...
    let testclass_get_value_async_func = lib.declare_native_function("testclass_get_value_async")?
        .param("testclass", Type::ClassRef(testclass.clone()))?
