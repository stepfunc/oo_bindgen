...
pub fn define(lib: &mut LibraryBuilder) -> Result<(), BindingError> {
    ...
    lib.define_static_class("integer_echo_functions")?
        .static_method("uint8_echo", &uint8_echo)?
        .static_method("sint8_echo", &sint8_echo)?
        .static_method("uint16_echo", &uint16_echo)?
        .static_method("sint16_echo", &sint16_echo)?
        .static_method("uint32_echo", &uint32_echo)?
        .static_method("sint32_echo", &sint32_echo)?
        .static_method("uint64_echo", &uint64_echo)?
        .static_method("sint64_echo", &sint64_echo)?
